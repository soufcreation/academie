  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        <div className="relative hidden md:flex w-40 md:w-48 h-40 md:h-48 mb-8">
          <Image
            src="/logo.png"
            alt="Académie Européenne des Sports"
            fill
        ...
        {/* CTA Buttons - Zones tactiles agrandies avec effet ripple */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#tarifs"
            className="btn-interactive inline-flex items-center gap-2 bg-[#e63030] hover:bg-[#d42929] text-white px-8 py-4 text-lg font-semibold uppercase tracking-wider transition-all min-h-[52px]"
          >
          ...
          <a
            href="#disciplines"
            className="btn-interactive inline-flex items-center gap-2 border-2 border-white hover:bg-white hover:text-black text-white px-8 py-4 text-lg font-semibold uppercase tracking-wider transition-all min-h-[52px]"
          >
            Découvrir les cours
