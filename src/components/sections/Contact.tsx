      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Google Map - Conditional loading */}
          ...
          {/* Video Reel */}
          <div className="bg-gray-900/50 border border-gray-800 p-4 md:p-8">
            <h3
              className="text-2xl font-bold tracking-wider mb-6 text-center"
              style={{ fontFamily: "var(--font-bebas)" }}
            >
              DÉCOUVREZ NOTRE ACADÉMIE
            </h3>
            <div className="rounded-lg overflow-hidden bg-black w-full max-w-sm mx-auto">
              <VideoJSPlayer
                src="https://res.cloudinary.com/dez3imdcy/video/upload/f_auto,q_auto/academie-reel_n9gxfu.mp4"
                aspectRatio="9:16"
                className="w-full"
              />
            </div>
