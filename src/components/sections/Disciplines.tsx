  ...
  return (
    <section id="disciplines" className="py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {disciplines.map((discipline) => {
            ...
            return (
              <div key={discipline.id}>
                ...
                >
                  <div className={`inline-flex items-center justify-center w-14 h-14 mb-4 bg-black ${hasImage ? "" : "group-hover:bg-[#e63030]"} transition-colors overflow-hidden`}>
                    {hasImage ? (
                      <Image
        ...
        {/* Planning Button - après toutes les disciplines */}
        <div className="mt-8 text-center">
          <a
            href="/planning"
            className="inline-block py-4 px-8 border-2 border-white hover:bg-white hover:text-black text-white font-semibold uppercase tracking-wider transition-all"
          >
            <span
