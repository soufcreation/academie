...
export default function Coaches({ limit, showDescription = true, showTitle = true }: CoachesProps) {
            ...
            >
              ...
              <div className="aspect-[4/5] bg-gray-900 relative">
                <Image
                  ...
                  alt={coach.name}
                  fill
                  className={`object-cover transition-transform duration-500 group-hover:scale-105 ${coach.id === 3 ? 'object-[50%_25%] scale-110' : 'object-top'}`}
                />
                {/* Overlay */}
